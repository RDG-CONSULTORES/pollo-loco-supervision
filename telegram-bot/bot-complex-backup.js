...
// Web App Integration para dashboard
...
// Initialize Express app for dashboard and webhook
const app = express();
...
if (process.env.NODE_ENV === 'production') {
    ...
    if (webhookUrl) {
        ...
        console.log('⚠️ WEBHOOK_URL not configured for production');
    }
...
// Comando /dashboard - Mostrar dashboard interactivo
...
// GET /api/performance/trends - Tendencias
...
app.listen(port, () => {
    ...
    console.log(`📊 Dashboard available at: ${WEBAPP_URL}/dashboard`);
    console.log(`🤖 Telegram webhook: ${WEBAPP_URL}/webhook`);
});
